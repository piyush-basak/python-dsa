# To create a doubly linked list and insert,delete,reverse through all options by Sarasij Majumdar, Techno International Newtown
class Node:
...
new_linked_list.insert_before_item(39, 100)
...
new_linked_list.delete_after_node(5)
new_linked_list.traverse_list()
